  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex">
            <div className="w-6/12 pt-52">
              <h1 className="text-accent-2 font-bold text-lg uppercase mb-6">
          ...
          <div className="flex">
            <div className="w-6/12 pl-8 pr-20">
              <div className="flex flex-col mb-16">
                ...
                <h3 className="font-serif text-5xl text-gray-900 leading-snug mb-10">Book your next trip in 3 easy steps</h3>
        ...
        <div className="max-w-7xl mx-auto relative px-4">
          ...
          <div className="w-full relative bg-white">
            <div className="relative">
              <div className="absolute flex justify-center items-center z-30 text-white transfrom -translate-y-1/2 translate-x-1/2 rounded-full top-0 right-0 w-16 h-16 bg-gradient-to-b from-accent-6/60 to-accent-6">
                <span class="material-symbols-outlined">near_me</span>
              </div>
              <div className="bg-accent-3/20 overflow-hidden rounded-tl-[129px] rounded-3xl relative z-20 pt-20 pb-20 mb-8">
                <div className="w-[248px] h-[290px] absolute z-0 -top-16 -right-20 transfrom -rotate-90">
                  <DecorEllips1 className="stroke-accent-6 opacity-10" />
                </div>
                <div className="w-[390px] h-[397px] absolute z-0 -bottom-44 left-8 transfrom rotate-6">
                  <DecorEllips1 className="stroke-accent-6 opacity-10" />
                </div>
                <div className="relative">
                  <div className="relative z-10">
                    ...
                    <form className="flex justify-center">
                      ...
                      <button className="rounded-lg text-white bg-gradient-to-b from-accent-2/90 to-accent-2 py-5 px-16">Subscribe</button>
                    </form>
                  </div>
                </div>
              </div>
      ...
      <section className="pb-32 relative overflow-hidden">
        <div className="w-60 h-60 rounded-full blur-3xl absolute z-10 -bottom10 -right-10 bg-accent-6/20"></div>
        <div className="max-w-7xl mx-auto relative px-4">
